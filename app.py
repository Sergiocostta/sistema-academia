...
def cadastro():
    if request.method == 'POST':
        ...
        for carac in usuario:
            if not (carac.isalpha() or carac.isdigit()):
                return render_template("cadastro.html", erro="Preencha a area do Usuario somente com letras e números")
